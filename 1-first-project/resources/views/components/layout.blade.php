...
<body>
    ...
    {{-- display different component content --}}
            ...
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div class="flex h-16 items-center justify-between">
                    <div class="flex items-center">
                        <div class="shrink-0">
                            <img class="size-8"
                                src="https://static.vecteezy.com/system/resources/previews/014/845/965/non_2x/initial-ps-feminine-logo-usable-for-nature-salon-spa-cosmetic-and-beauty-logos-flat-logo-design-template-element-vector.jpg"
                                alt="Your Company">
                        </div>
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-4">
                                ...
                                <a href="/home"
                                    class="{{ request()->is('home') ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }} rounded-md px-3 py-2 text-sm font-medium"
                                ...
                                <div>
                                    <button type="button"
                                        ...
                                        <img class="size-8 rounded-full"
                                            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcThUlFk6ztoS6znLegtBGvOKgCJ4lPDTOoAXk0BHsMklfTSrzfh8a9LDqxXdzBt4OELqZo&usqp=CAU"
                                            alt="">
                                    </button>
                                </div>
